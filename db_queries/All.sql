...
INSERT INTO User (User_name, First_name, Last_name, Date_of_birth, Country, NIC_code, Gender, Email, Role, Password)
VALUES 
('admin', 'admin', 'admin', '2024-10-01', 'Sri Lanka', '20022470923', 'Male', 'admin@gmail.com', 'Admin', '$2b$10$zFM/CtHqkECfSMAog2PcluQUDOOHEMzUYCHWGy39D7bul17cYqRHu');
...
('FL020', 5, 'RT020', '2024-10-27', '2024-10-27', '09:00:00', '11:00:00', 'Cancelled'),
('FL021', 1, 'RT001', '2024-10-27', '2024-10-27', '08:00:00', '10:00:00', 'Scheduled'),
('FL022', 2, 'RT002', '2024-10-27', '2024-10-27', '12:00:00', '14:30:00', 'Scheduled'),
('FL023', 3, 'RT003', '2024-10-27', '2024-10-27', '15:00:00', '17:00:00', 'Delayed'),
('FL024', 4, 'RT004', '2024-10-27', '2024-10-27', '18:00:00', '20:30:00', 'Scheduled'),
('FL025', 5, 'RT005', '2024-10-27', '2024-10-27', '09:00:00', '11:00:00', 'Cancelled'),
('FL026', 1, 'RT006', '2024-10-27', '2024-10-27', '08:00:00', '10:00:00', 'Scheduled'),
('FL027', 2, 'RT007', '2024-10-27', '2024-10-27', '12:00:00', '14:30:00', 'Scheduled'),
('FL028', 3, 'RT008', '2024-10-27', '2024-10-27', '15:00:00', '17:00:00', 'Delayed'),
('FL029', 4, 'RT009', '2024-10-27', '2024-10-27', '18:00:00', '20:30:00', 'Scheduled'),
('FL030', 5, 'RT010', '2024-10-27', '2024-10-27', '09:00:00', '11:00:00', 'Cancelled');
...
(2, '5678', '2028-09-15', 'Sarah', '1990-03-12', 'Female'),
(3, '9012', '2029-07-22', 'John', '1985-11-30', 'Male'),
(4, '3456', '2031-04-18', 'Emily', '1998-08-05', 'Female'),
(5, '7890', '2027-11-09', 'Michael', '1976-02-14', 'Male'),
(6, '2345', '2032-01-25', 'Jessica', '2001-06-20', 'Female'),
(7, '6789', '2029-03-07', 'David', '1988-09-03', 'Male'),
(8, '0123', '2030-08-11', 'Lisa', '1995-12-28', 'Female'),
(9, '4567', '2028-05-30', 'Daniel', '1982-04-17', 'Male'),
(10, '8901', '2031-10-14', 'Sophia', '2005-07-09', 'Female');
...
VALUES
-- FL001 bookings
('bk_1', 'FL001', 1, 'P001_S001', '2023-06-01 10:00:00', 450.00),
('bk_2', 'FL001', 2, 'P001_S002', '2023-06-01 10:15:00', 450.00),
('bk_3', 'FL001', 3, 'P001_S115', '2023-06-01 11:00:00', 900.00),
('bk_4', 'FL001', 4, 'P001_S145', '2023-06-01 11:30:00', 1500.00),

-- FL002 bookings
('bk_5', 'FL002', 5, 'P002_S010', '2023-06-02 09:00:00', 500.00),
('bk_6', 'FL002', 6, 'P002_S011', '2023-06-02 09:15:00', 500.00),
('bk_7', 'FL002', 7, 'P002_S120', '2023-06-02 10:00:00', 1000.00),
('bk_8', 'FL002', 8, 'P002_S150', '2023-06-02 10:30:00', 1600.00),

-- FL003 bookings
('bk_9', 'FL003', 9, 'P008_S001', '2023-06-03 08:00:00', 550.00),
('bk_10', 'FL003', 10, 'P008_S002', '2023-06-03 08:15:00', 550.00),
('bk_11', 'FL003', 1, 'P008_S400', '2023-06-03 09:00:00', 1100.00),
('bk_12', 'FL003', 2, 'P008_S476', '2023-06-03 09:30:00', 1700.00),

-- FL004 bookings
('bk_13', 'FL004', 3, 'P004_S020', '2023-06-04 11:00:00', 600.00),
('bk_14', 'FL004', 4, 'P004_S021', '2023-06-04 11:15:00', 600.00),
('bk_15', 'FL004', 5, 'P004_S136', '2023-06-04 12:00:00', 1200.00),
('bk_16', 'FL004', 6, 'P004_S157', '2023-06-04 12:30:00', 1800.00),

-- FL005 bookings
('bk_17', 'FL005', 7, 'P005_S030', '2023-06-05 13:00:00', 650.00),
('bk_18', 'FL005', 8, 'P005_S031', '2023-06-05 13:15:00', 650.00),
('bk_19', 'FL005', 9, 'P005_S140', '2023-06-05 14:00:00', 1300.00),
('bk_20', 'FL005', 10, 'P005_S160', '2023-06-05 14:30:00', 1900.00);
